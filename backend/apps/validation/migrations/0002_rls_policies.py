"""Enable RLS on validation_issue — tenant isolation.

Same pattern as ingestion/0002 and submission/0002: per-table CREATE
POLICY, Postgres-gated via RunPython + connection.vendor, no-op on
SQLite for the test backend.
"""
...
TENANT_TABLES: tuple[str, ...] = ("validation_issue",)
