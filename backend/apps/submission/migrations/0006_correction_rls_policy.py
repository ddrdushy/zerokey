"""Enable RLS on extraction_correction — same per-tenant isolation pattern."""
...
TENANT_TABLES: tuple[str, ...] = ("extraction_correction",)
...
class Migration(migrations.Migration):
    dependencies = [
        ("submission", "0005_extractioncorrection"),
    ]
