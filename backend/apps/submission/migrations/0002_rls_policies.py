"""Enable RLS on invoice and line_item.

LineItem is tenant-scoped directly (not just via parent Invoice) for
defensive depth: a JOIN bug that fails to filter through Invoice cannot
leak line-item rows because line_item enforces RLS itself.
"""
...
TENANT_TABLES: tuple[str, ...] = ("invoice", "line_item")
