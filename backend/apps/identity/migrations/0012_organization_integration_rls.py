"""Enable RLS on identity_organization_integration (Slice 57)."""
...
TENANT_TABLES: tuple[str, ...] = ("identity_organization_integration",)
...
class Migration(migrations.Migration):
    dependencies = [
        ("identity", "0011_organization_integration"),
    ]
